...
expid={'d', 'rl' , 'tk', 'v','ra' , 's', 'u' , 'e' };


% Define Parameters
paramn={'d_mom','rlam_heat', 'tkhmin', 'v0snow',  'radfac' , 'soilh' ,'uc1',  'e_surf'}; % No TEX interpreter
paramnt={'d\_mom','rlam\_heat', 'tkhmin', 'v0snow', 'radfac', 'soilh' , 'uc1',  'e\_surf'}; % No TEX interpreter
...
default={[d_mom log(rlam_heat) tkhmin v0snow radfac log(soilh) uc1 log(e_surf)]};
...
valdata=[3.2188 log(4.2212) 1.6346 13.7661 0.4749 log(0.3169) 1.2902 log(3.0281); % IND1
    13.9604 log(2.3665) 1.7370 10.4912 0.3222 log(2.5761) 1.3508 log(0.5657); %IND2
   12.5804 log(0.5954) 0.1231 14.9506 0.8710 log(0.2903) 0.8493 log(6.6516)]; %IND3
